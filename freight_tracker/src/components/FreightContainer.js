...
class FreightContainer extends Component {
    ...
    //function for addFreight with async promise
    addFreight = async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            this.createFormRef.current.reset();
    ...
    getFreight = async () => {
        try {
            ...
            const parsedProducts = await products.json().then((product)=>{
                console.log(product, 'line76')
                this.setState({
        ...
        return (
            ...
            <div className="container">
                ...
                <form className="col" onSubmit={this.addFreight}>
                    ...
                    <button className="btn waves-effect waves-light" type="submit" onClick={this.hideCreateForm}><i className="material-icons right">local_shipping</i>
                ...
                : null}
                <button type="button" onClick={this.showCreateForm}>Create Inbound Freight</button>
                <div className="row">
